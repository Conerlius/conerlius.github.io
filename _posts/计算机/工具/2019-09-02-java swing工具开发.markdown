...
> ![png](/images/computer/tool/java_swing/java_swing_create_window1.jpg)
> 
> 在创建窗口界面上，注意``1``不要勾上，直接`Next`就可以了
> ![png](/images/computer/tool/java_swing/java_swing_create_window2.jpg)
> 
> 在这里，我们勾选上`Create project from template`，然后`next`
> ![png](/images/computer/tool/java_swing/java_swing_create_window3.jpg)
> 
> 填写上一些必须的名称后，`Finish`
> ![png](/images/computer/tool/java_swing/java_swing_create_window4.jpg)
> 
> ![png](/images/computer/tool/java_swing/java_swing_create_swing1.jpg)
...
> ![png](/images/computer/tool/java_swing/java_swing_create_swing2.jpg)
> 
> ![png](/images/computer/tool/java_swing/java_swing_create_swing3.jpg)
> * 注`1`填写的是GUI配置文件的名称
> * 注`2`填写的是GUI的布局样式
> * 注`3`填写的是GUI绑定的文件
>> GUI的布局样式主要有一下几种
...
### 如何放置控件
> ![gif](/images/computer/tool/java_swing/java_swing_label.gif)
### JPanel
...
>> ![png](/images/computer/tool/java_swing/java_swing_label2.png)
>> 
>> 第一个框出来的是jlabel的对齐方式
>> 黑色的框是JLabel的大小设置 
### JButton
...
>> ![gif](/images/computer/tool/java_swing/java_swing_button.gif)
>
