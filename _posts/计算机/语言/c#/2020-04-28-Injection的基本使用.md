...
- 怎么查看il代码？
  ...
  - 首先是编译项目
    ...
    ![injection_3](/images/computer/lang/csharp/injection/injection_3.png)

    然后就是等待编译完成，成功后，`il view`会自动刷新，失败就保留上一次的结果。

  - 打开il视图

    ![injection_4](/images/computer/lang/csharp/injection/injection_4.png)
...
![png](/images/computer/lang/csharp/injection/injection_5.png)